...
import { School, Layers, Download, Calendar, ChevronDown, Landmark } from "lucide-react";  
...
export default function Dashboard() {
  ...
  return (
    <AuthenticatedLayout>
        ...
        <div className="w-full md:ml-[120px] p-6">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <Box component="form" className="flex items-center space-x-4">
              ...
              {/* Lucide Date Picker with Calendar Icon */}
              <DatePicker
                selected={date}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div className="bg-white p-5 rounded-2xl border-2 border-gray-200 flex flex-col items-center">
              ...
              <Bar
                ...
                width={300}  // Adjusted chart width
      ...
      <footer className="text-center py-4 border bg-white text-[#455185]">
...
function SummaryCard({ title, value, icon }) {
  return (
    <div className="bg-white p-5 rounded-2xl border-2 border-gray-150 flex items-center gap-4 hover:scale-105 transform transition duration-300 ease-in-out">
      ...
      >
        <icon.Component style={{ color: icon.color, fontSize: "40px" }} />
      </div>
