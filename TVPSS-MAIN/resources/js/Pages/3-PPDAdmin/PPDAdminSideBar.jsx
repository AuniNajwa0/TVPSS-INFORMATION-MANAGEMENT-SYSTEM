...
import { FaCog, FaSignOutAlt, FaTh, FaInfoCircle, FaChartPie, FaUsers, FaBars, FaTimes } from 'react-icons/fa';
    ...
    <div>
      ...
      >
        ...
        <div className="mt-auto">
          ...
          <h3 className="text-sm font-semibold text-gray-600 uppercase mb-4">Umum</h3>
          <nav className="space-y-4">
            <SidebarLink
